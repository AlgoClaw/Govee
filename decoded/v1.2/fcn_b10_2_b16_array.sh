...
# sudo bash "/path/to/b10_2_b16_array.sh" "/path/to/JSONs/H6065_debug.json" "sceneId_b10" "sceneId_b16" "/path/to/JSONs/H6065_debug_2.json"
...
###############################################################
# Create bash array of "b10_array" values
